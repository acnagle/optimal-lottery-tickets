...
for arch in TwoLayerFC FourLayerFC; do
    ...
    for epochs in 30 50 100 125 150; do
        ...
        python3 main.py --gpu $gpu --lr 0.01 --epochs $epochs --arch "LeNet5" --save-results > "./results/LeNet5/e${epochs}_h${hidden_size}.out"
    done
done
