...
class WideTwoLayerFC(nn.Module):
    def __init__(self, input_size, num_classes, args):
        ...
        #TODO: calculate hidden size
        self.fc1 = SupermaskLinear(in_features=input_size, out_features=args.hidden_size, sparsity=args.sparsity, bias=args.bias)
        self.fc2 = SupermaskLinear(in_features=args.hidden_size, out_features=num_classes, sparsity=args.sparsity, bias=args.bias)
...
class WideFourLayerFC(nn.Module):
    def __init__(self, input_size, num_classes, args):
        ...
        self.fc1 = SupermaskLinear(in_features=input_size, out_features=args.hidden_size, sparsity=args.sparsity, bias=args.bias)
        self.fc2 = SupermaskLinear(in_features=args.hidden_size, out_features=args.hidden_size, sparsity=args.sparsity, bias=args.bias)
        self.fc3 = SupermaskLinear(in_features=args.hidden_size, out_features=args.hidden_size, sparsity=args.sparsity, bias=args.bias)
        self.fc4 = SupermaskLinear(in_features=args.hidden_size, out_features=num_classes, sparsity=args.sparsity, bias=args.bias)
...
class WideFCLeNet5(nn.Module):
    def __init__(self, input_size, num_classes, args):
        super(WideFCLeNet5, self).__init__()
        ...
        b = in1 + num_classes
        c = in1 * args.r + in1 * args.r * in2 + in2 * args.r + in2 *args. r * in3 + in3 *args. r + in3 * args.r * num_classes
        ...
        self.conv1.weight.requires_grad = False     # TODO: This assumes weights are loaded in... get rid of this/modify it
